...
par(mfcol = c(2, 2))
#Define top left image
plot(dataset$DateTime, dataset$Global_active_power, type = 'l',xlab = " ", ylab = 'Global Active Power(kilowatt)')
#Define top right image
plot(dataset$DateTime, as.numeric(as.character(dataset$Voltage)),  type = 'l', xlab = "datetime", ylab = "Voltage") 
#Define bottom left image
